<%@ page import="com.business.LoginRecord" %>
...
<div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
  <header class="demo-header mdl-layout__header mdl-color--grey-100 mdl-color-text--grey-600">
    <div class="mdl-layout__header-row">
      <span class="mdl-layout-title">登录记录</span>
  ...
  <main class="mdl-layout__content mdl-color--grey-100">
    ...
    <%List<LoginRecord> recordList = Database.getAllLoginRecord();%>
    <table class="mdl-data-table mdl-js-data-table mdl-shadow--2dp">
      ...
      <tr>
        <th>手机号码</th>
        <th>登录时间</th>
        <th class="mdl-data-table__cell--non-numeric">登录状态</th>
      </tr>
      </thead>
      ...
      <tr>
        <td><%=loginRecord.getPhone()%></td>
        <td><%=loginRecord.getDate()%></td>
        <td class="mdl-data-table__cell--non-numeric"><%=loginRecord.getStrStatus()%></td>
      </tr>
      <%}%>
      </tbody>
