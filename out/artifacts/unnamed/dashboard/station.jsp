<%@ page import="com.business.Station" %>
...
<div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
  <header class="demo-header mdl-layout__header mdl-color--grey-100 mdl-color-text--grey-600">
    <div class="mdl-layout__header-row">
      <span class="mdl-layout-title">电站列表</span>
      ...
      <table class="mdl-data-table mdl-js-data-table mdl-shadow--2dp">
        <thead>
          <tr>
            ...
            <th class="mdl-data-table__cell--non-numeric">电站地址</th>
            <th class="mdl-data-table__cell--non-numeric">已预约电池数</th>
            <th class="mdl-data-table__cell--non-numeric">电池总数</th>
